...
from .views import (
serve_manuscript_image,serve_image_by_filename,get_manuscript_files,serve_image,upload_folder_view,
serve_uploaded_image,manuscript_grounds,
    manuscript_list_create,developer_model_parameters_view,reject_developer_request,admin_manage_requests,
    delete_manuscript,ground_folder_xmls,delete_ground_xml,
    manuscript_files,developer_request_create,developer_request_list,
...
serve_processed_image,get_manuscript_file,get_model_parameters,approve_developer_request,

    run_uploaded_script_on_image,list_all_developer_models,download_manuscript_zip
...
path('developer-requests/', developer_request_create, name='developer-request-create'),
    path('admin/developer-requests/', developer_request_list, name='developer-request-list'),
    path('admin/manage-requests/', admin_manage_requests, name='admin-manage-requests'),
    path('admin/developer-requests/<int:request_id>/approve/', approve_developer_request,
         name='approve-developer-request'),
    path('admin/developer-requests/<int:request_id>/reject/', reject_developer_request,
         name='reject-developer-request'),
path('manuscripts/<int:manuscript_id>/upload-folder/', upload_folder_view),
    path('manuscripts/<int:manuscript_id>/download/', download_manuscript_zip, name='download_manuscript_zip'),
